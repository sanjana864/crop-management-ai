...
import { Cloud, Leaf, ArrowDown, Brain, Camera, BookOpen, ChevronDown, Sprout } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="grid md:grid-cols-2 gap-x-8">
            ...
            <WorkflowStep
              ...
              description={t('cropSuggestionsDesc')}
      ...
      <section id="weather" className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-8">
            <a href="#crop-suggestions" className="inline-flex items-center gap-2 text-primary font-semibold hover:underline">
              {t('nextCropSuggestions')} <ChevronDown className="w-5 h-5" />
            </a>
          </div>
        </div>
      </section>

      {/* Step 2: Crop Suggestions Based on Weather */}
      <section id="crop-suggestions" className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-growth/10 px-4 py-2 rounded-full mb-4">
              ...
              <Sprout className="w-5 h-5 text-growth" />
              <span className="font-medium text-growth">{t('cropSuggestions')}</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold">{t('cropSuggestionsTitle')}</h2>
            <p className="text-muted-foreground mt-2">{t('cropSuggestionsSubtitle')}</p>
          </div>
      ...
      {/* Additional Tools: Camera & Voice */}
      <section id="tools" className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-accent/10 px-4 py-2 rounded-full mb-4">
              <Camera className="w-5 h-5 text-accent" />
              <span className="font-medium text-accent">{t('additionalTools')}</span>
            </div>
